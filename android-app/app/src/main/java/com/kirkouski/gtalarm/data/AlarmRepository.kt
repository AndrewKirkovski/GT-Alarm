...
class AlarmRepository @Inject constructor(
    ...
    private suspend fun applyPendingDismissals() {
        ...
        pending.forEach { id ->
            ...
            when (com.kirkouski.gtalarm.ring.AlarmRingService.dismissAction(alarm)) {
                com.kirkouski.gtalarm.ring.AlarmRingService.DismissAction.DELETE -> delete(id)
                com.kirkouski.gtalarm.ring.AlarmRingService.DismissAction.DISABLE ->
                    setEnabledLocalOnly(id, false)
                com.kirkouski.gtalarm.ring.AlarmRingService.DismissAction.KEEP -> Unit
            }
        }
    }
